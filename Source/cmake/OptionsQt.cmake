...
macro(CHECK_Qt6_PRIVATE_INCLUDE_DIRS _qt_component _header)
    ...
    message("Private includes : ${Qt6${_qt_component}_PRIVATE_INCLUDE_DIRS}")
...
if (QT_STATIC_BUILD)
    ...
    if(AMIGA)
        list(APPEND STATIC_LIB_DEPENDENCIES -lz -lpcre2-16 -lpthread -licui18n -licuuc -licudata)
    endif()
endif ()
